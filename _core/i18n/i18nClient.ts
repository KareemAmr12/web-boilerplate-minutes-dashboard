...
import { ELanguage, LOCALE_COOKIE_KEY } from '@core/constants/locale';
import { getCookie, setCookie } from '@core/utils/client';
import coreConfig from '@core/config';
import { getLangFromPathname, getLocaleConfig } from '@core/utils/locale';
import { TLocaleSEO } from '@core/types/locale';
