import { ECountrySeo, ELanguage, getApiCountryForSeoCountry, RTLLanguages } from '@core/constants/locale';
import { TLocaleAPI, TLocaleConfig, TLocaleSEO } from '@core/types/locale';
